...
features:
  ...
  - title: Search
    ...
    video:
      src: https://packages.rmilo.dev/images/v0.0.4/rgallery-search.mp4
  - title: Map view
    content: Explore your geo-tagged memories across the world.
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-map-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-map-1600.png 1600w
      width: 3600
      height: 2150
  - title: Reverse geocoding
    content: Tag media items with cities and countries from EXIF coordinates without external API calls over the internet.
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-reverse-geocode-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-reverse-geocode-1600.png 1600w
      width: 2922
      height: 1902
  - title: Infinite slider
    content: Swipe through your media library until the very end.
    video:
      src: https://packages.rmilo.dev/images/v0.0.4/rgallery-slider-1.mp4
  - title: Permalinks
    content: Every image and video gets a unique, persistent URL. If you update your image, the link remains the same.
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-permalink-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-permalink.png 1376w
      width: 1376
      height: 854
  - title: Metadata at a glance
    ...
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-metadata-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-metadata-1600.png 1600w
      width: 3600
      height: 1834
  - title: Memories
    content: Revisit relevant events that happened "on this day," and instantly scroll to that date on your timeline.
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-memories-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-memories.png 1406w
      width: 1406
      height: 1044
  - title: Gear stats
    content: Analyze your media collection by camera, lens, focal length, and more.
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-gear-stats-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-gear-stats-1600.png 1600w
      width: 3596
      height: 1852
  - title: Folder view
    content: A recursive look into your library's folder structure.
    image:
      srcset: https://packages.rmilo.dev/images/v0.0.4/rgallery-folders-800.png 800w, https://packages.rmilo.dev/images/v0.0.4/rgallery-folders-1600.png 1600w
      width: 3600
      height: 1842
---
