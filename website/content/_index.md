...
LinkTitle: rgallery
description: rgallery unifies your photo and video collection into a single, elegant web interface, complete with a timeline view, memories, favorites, folders, EXIF metadata, map view, and more.
featured_image: '/media/rgallery-timeline-3.png'
lead:
  title: The open source timeline for your photo and video library.
  content: |
  ...
  image: /rgallery-timeline-dark.png
  alt: rgallery timeline dark mode
  install:
    link: /docs/install/
    text: Install rgallery
footer_notice: |
